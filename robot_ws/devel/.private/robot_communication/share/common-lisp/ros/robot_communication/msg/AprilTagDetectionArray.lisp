...
(cl:defclass <AprilTagDetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector robot_communication-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'robot_communication-msg:AprilTagDetection :initial-element (cl:make-instance 'robot_communication-msg:AprilTagDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_communication-msg:<AprilTagDetectionArray> is deprecated: use robot_communication-msg:AprilTagDetectionArray instead.")))
...
(cl:defmethod detections-val ((m <AprilTagDetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_communication-msg:detections-val is deprecated.  Use robot_communication-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robot_communication-msg:AprilTagDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetectionArray>)))
  ...
  "robot_communication/AprilTagDetectionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetectionArray)))
  "Returns string type for a message object of type 'AprilTagDetectionArray"
  "robot_communication/AprilTagDetectionArray")
