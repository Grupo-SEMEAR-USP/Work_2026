...
"""autogenerated by genpy from robot_communication/AprilTagDetectionArray.msg. Do not edit."""
import codecs
import sys
...
class AprilTagDetectionArray(genpy.Message):
  ...
  _type = "robot_communication/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','robot_communication/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robot_communication.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
