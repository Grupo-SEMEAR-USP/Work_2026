...
(cl:defmethod front_left-val ((m <velocity_comm>))
...
(cl:defmethod front_right-val ((m <velocity_comm>))
...
(cl:defmethod rear_left-val ((m <velocity_comm>))
...
(cl:defmethod rear_right-val ((m <velocity_comm>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<velocity_comm>)))
  ...
  (cl:format cl:nil "# velocity_comm.msg~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'velocity_comm)))
  "Returns full string definition for message of type 'velocity_comm"
  (cl:format cl:nil "# velocity_comm.msg~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%"))
